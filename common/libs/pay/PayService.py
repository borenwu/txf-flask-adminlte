...
class PayService():
    ...
    def createOrder(self, member_id, platform_id, community_id, community_name, items=None, params=None):
        ...
        try:
            ...
            model_pay_order.platform_id = platform_id
            model_pay_order.community_id = community_id
            model_pay_order.community_name = community_name
            ...
            for item in items:
                ...
                tmp_pay_item.platform_id = platform_id
                tmp_pay_item.community_id = community_id
                tmp_pay_item.community_name = community_name
    ...
    def orderSuccess(self, pay_order_id=0, params=None):
        try:
            ...
            for order_item in pay_order_items:
                ...
                user = User.query.filter(User.platform_id == order_item.platform_id).filter(
                    User.community_name == order_item.community_name).first()
