...
CREATE TABLE `user` (
  ...
  `benefit` decimal(10,2)  DEFAULT '0.00' COMMENT '提成金额',
...
CREATE TABLE `platform` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '' COMMENT '社区名称',
...
CREATE TABLE `community` (
  ...
  `city` varchar(100) NOT NULL DEFAULT '' COMMENT '城市',
  `description` varchar(2000) NOT NULL DEFAULT '' COMMENT '描述',
  `pickups` varchar(2000) NOT NULL DEFAULT '' COMMENT '自提点，以","连接',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1：有效 0：无效',
...
CREATE TABLE `food` (
  ...
  `platform_id` int(11) NOT NULL DEFAULT '0' COMMENT '平台id',
  `platform_name` varchar(100) NOT NULL DEFAULT '' COMMENT '平台名称',
  `communities` varchar(1000) NOT NULL DEFAULT '' COMMENT '社区，以","连接',
  `cat_id` int(11) NOT NULL DEFAULT '0' COMMENT '分类id',
  `date_from` timestamp NOT NULL COMMENT '开始日期',
  `date_to` timestamp NOT NULL COMMENT '结束日期',
  `name` varchar(100) NOT NULL DEFAULT '' COMMENT '书籍名称',
  `ratio` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '提成比例',
  `market_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '市场金额',
...
CREATE TABLE `food_sale_change_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `pay_order_item_id` int(11) NOT NULL DEFAULT '0' COMMENT '订单项目id',
